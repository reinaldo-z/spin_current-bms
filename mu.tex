...
$\rho_{nm}(\bfk;t)$, one can show that,\cite{nastosPRB07} \cite{}
...
\end{eqnarray}
is
denoted as the \textit{spin-injection 3$^\mathrm{rd}$ rank
 pseudo-tensor component}.
 In simple terms, a pseudo-tensor is an object that transforms like a
  tensor under a proper rotation, but changes its sign under an improper
